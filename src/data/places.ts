...
const PLACES_BY_STATION: Record<string, Place[]> = {
  강남: [
    { name: '블루보틀 강남점', rating: 4.5, category: '카페', distance: '도보 3분', lat: 37.4979, lng: 127.0276 },
    { name: '스타벅스 강남대로점', rating: 4.2, category: '카페', distance: '도보 5분', lat: 37.4982, lng: 127.0271 },
    { name: '더플레이스', rating: 4.6, category: '맛집', distance: '도보 7분', lat: 37.4975, lng: 127.0280 },
    { name: '모수', rating: 4.8, category: '맛집', distance: '도보 10분', lat: 37.4990, lng: 127.0265 },
    { name: '르 챔버', rating: 4.7, category: '술집', distance: '도보 5분', lat: 37.4985, lng: 127.0270 },
    { name: '익스퀴진', rating: 4.4, category: '술집', distance: '도보 8분', lat: 37.4972, lng: 127.0285 },
  ],
  홍대입구: [
    { name: '연남동 카페 FRITZ', rating: 4.6, category: '카페', distance: '도보 5분', lat: 37.5575, lng: 126.9237 },
    { name: '카페 온도', rating: 4.3, category: '카페', distance: '도보 3분', lat: 37.5578, lng: 126.9250 },
    { name: '홍대 양꼬치거리', rating: 4.4, category: '맛집', distance: '도보 7분', lat: 37.5565, lng: 126.9230 },
    { name: '경성양꼬치', rating: 4.5, category: '맛집', distance: '도보 6분', lat: 37.5570, lng: 126.9240 },
    { name: '에디오피아', rating: 4.6, category: '술집', distance: '도보 4분', lat: 37.5580, lng: 126.9245 },
    { name: '수상한포차', rating: 4.2, category: '술집', distance: '도보 8분', lat: 37.5560, lng: 126.9235 },
  ],
  신촌: [
  ...
  왕십리: [
    { name: '카페 모어', rating: 4.2, category: '카페', distance: '도보 4분', lat: 37.5617, lng: 127.0367 },
    { name: '이디야 왕십리점', rating: 3.9, category: '카페', distance: '도보 3분', lat: 37.5620, lng: 127.0370 },
    { name: '왕십리 곱창골목', rating: 4.5, category: '맛집', distance: '도보 6분', lat: 37.5610, lng: 127.0360 },
    { name: '하남돼지집 왕십리', rating: 4.4, category: '맛집', distance: '도보 8분', lat: 37.5625, lng: 127.0355 },
    { name: '골든티켓', rating: 4.3, category: '술집', distance: '도보 5분', lat: 37.5615, lng: 127.0365 },
    { name: '더 부스 왕십리', rating: 4.4, category: '술집', distance: '도보 7분', lat: 37.5608, lng: 127.0372 },
  ],
  사당: [
  ...
  서울역: [
    { name: '카페 서울로', rating: 4.3, category: '카페', distance: '도보 5분', lat: 37.5547, lng: 126.9705 },
    { name: '스타벅스 서울역점', rating: 4.1, category: '카페', distance: '도보 3분', lat: 37.5550, lng: 126.9710 },
    { name: '해장국 서울역', rating: 4.4, category: '맛집', distance: '도보 6분', lat: 37.5542, lng: 126.9698 },
    { name: '남대문 갈치조림', rating: 4.5, category: '맛집', distance: '도보 10분', lat: 37.5533, lng: 126.9750 },
    { name: '서울역 포차', rating: 4.1, category: '술집', distance: '도보 7분', lat: 37.5555, lng: 126.9702 },
    { name: '이태원 클라쓰', rating: 4.3, category: '술집', distance: '도보 9분', lat: 37.5540, lng: 126.9715 },
  ],
  시청: [
    { name: '카페 명동', rating: 4.2, category: '카페', distance: '도보 5분', lat: 37.5638, lng: 126.9761 },
    { name: '폴 바셋 시청점', rating: 4.4, category: '카페', distance: '도보 4분', lat: 37.5640, lng: 126.9765 },
    { name: '명동교자', rating: 4.7, category: '맛집', distance: '도보 8분', lat: 37.5630, lng: 126.9850 },
    { name: '을지면옥', rating: 4.6, category: '맛집', distance: '도보 10분', lat: 37.5660, lng: 126.9900 },
    { name: '시청 루프탑 바', rating: 4.4, category: '술집', distance: '도보 6분', lat: 37.5642, lng: 126.9758 },
    { name: '소호 재즈바', rating: 4.5, category: '술집', distance: '도보 9분', lat: 37.5635, lng: 126.9770 },
  ],
  종각: [
...
export function getPlacesByStation(station: string, category: string): Place[] {
  const allPlaces = PLACES_BY_STATION[station] || DEFAULT_PLACES;
  return allPlaces
